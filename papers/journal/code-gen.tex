...
% Another important special block is the \emph{fanout} block,
% which takes a single input and ``copies'' it to $n$ outputs. We
% denote this block $F_n$. The fanout block turns out to be
% another special case of the permutation block, and we can define
% 
% \[
% F_n = \Pi_1(1,\overset{n}{\ldots},1)
% \]
% 
...
Parallel composition for C is implemented similarly; Twig generates
