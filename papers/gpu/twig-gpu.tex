...
instead of tedious fine-grained implementation details. An exemplar of this approach
in the computational science domain is the Tensor Contraction Engine, which generates
low-level Fortran code from high-level mathematical notation~\cite{tce}.  The goal of DSLs is to
