...
Renaming is performed such that the composed block has two inputs and two outputs.}
\label{fig:codegen-par}
\end{figure}

\subsection{Special Blocks}

% Explain why we care about this.

Twig defines a special set of blocks called \emph{permutation} blocks. They are
named $\Pi_m(i_1,\ldots,i_n)$, and represent the primitive operation of
